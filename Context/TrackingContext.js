...
const ContractAddress = "0xb5abE308839C1f669F832a5478E83E539b4fD431"; // Add the contract address
...
export const TrackingProvider = ({children}) => {
    //State Variable
    const DappName = "Supply Chain Dapp";
    ...
    return (
        <TrackingContext.Provider value={{
            connectWallet, createShipment, getAllShipment, completeShipment, getShipment, 
            startShipment, getShipmentsCount, DappName, currentUser,
